...
public class Main {
    ...
    public static void initialiser() {
        ...
        Client c1 = new Client("M", "BORROTI MATIAS DANTAS", "Raphaël", "rborrotimatiasdantas4171@free.fr", "mdp1234",
                d1, "8 Rue Arago, Villeurbanne", "0328178508");
        Client c2 = new Client("Mme", "OLMEADA MARAIS", "Nor", "nolmeadamarais1551@gmail.com", "mdp1234", d2,
                "3 Rue Léon Fabre, Villeurbanne", "0418932546");
        Client c3 = new Client("M", "RINERD", "Julien", "jrinerd5241@yahoo.com", "mdp1234", d10,
                "10 Rue de la Jeunesse, Villeurbanne", "0727252485");

        // INITIALISATION DES EMPLOYES
        Employe e1 = new Employe("Mme", "SING", "Ainhoa", "asing8183@free.fr", "mdp1234", d4, 12, 17, true, 0,
                "0705224200");
        Employe e2 = new Employe("M", "ABDIULLINA", "David Alexander", "david-alexander.abdiullina@laposte.net",
                "mdp1234", d5, 0, 5, true, 10, "0590232772");
        Employe e3 = new Employe("M", "WOAGNER", "Moez", "moez.woagner@laposte.net", "mdp1234", d6, 14, 19, true, 5,
                "0832205629");
        Employe e4 = new Employe("M", "HONRY", "Matteo", "matteo.honry@yahoo.com", "mdp1234", d7, 9, 17, true, 6,
                "0482381862");
        Employe e5 = new Employe("M", "CECCANI", "Kevin", "kevin.ceccani@hotmail.com", "mdp1234", d8, 8, 14, true, 2,
                "0664426037");
        Employe e6 = new Employe("Mme", "VOYRET", "Alice", "alice.voyret@hotmail.com", "mdp1234", d9, 0, 5, true, 8,
                "0486856520");
    ...
    private static void clientConnecte(Client c) {
        // Methode correspond au portail Client - la fenetre apparait quand le Client
        // est connecte
    ...
    private static void employeConnecte(Employe e) {
        // Methode correspond au portail Employe - la fenetre apparait quand l'Employe
        // est connecte
    ...
    private static void remplirDemandeIntervention(Client login) {
        ...
        do {
            ...
            type = Saisie.lireInteger(
                    "Type d'intervention [1] Animal || [2] Livraison || [3] Urgence || [0] Retourner au menu de service: ");
            ...
            switch (type) {
                ...
                case 1:
                    ...
                    String nomAnimal = Saisie.lireChaine(
                            "L'espèce de votre animal (et son nom s'il en y a un). Par exemple: chien (Médor)  : ");
    ...
    private static void validerIntervention(Intervention i, Client login) {
        // Une fois que le formulaire est rempli, cette methode validera la nouvelle
        // intervention
    ...
    private static void confirmerClotureIntervention(Intervention i, String commentaire, String statut) {
        ...
        if (cloturee != null) {
            ...
            sms += ", votre demande d'intervention du " + i.getDateDeb().toString() + " a été cloturée à "
                    + i.getDateDeb().toString() + ". " + i.getCommentaire() + ". Cordialement, "
                    + i.getNomIntervenant();
    ...
    private static void annulerIntervention(Client login) {
        ...
        if (size == 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                System.out.println("Numero: " + i + "> Type d'intervention: " + temp.getTypeIntervention()
                        + ". Nom d'intervenant : " + temp.getNomIntervenant());
            }
    ...
    private static void saisirAuthentificationClient() {
        ...
        do {
            ...
            if (login == null) {
                System.out.println(
                        "Authentification invalide. Veuillez resaisir votre identifiant ou taper 0 pour terminer. ");

            }
        } while (!"0".equals(clientMail) && login == null);
        if (login != null) {
            System.out.println("Le client ayant l'identifiant (id, Nom, Prenom) : " + login.getId() + " "
                    + login.getNom() + " " + login.getPrenom() + " est connecté!");
            System.out.println();
            System.out.println("*****************");
    ...
    private static void saisirAuthentificationEmploye() {
        ...
        if (login != null) {
            System.out.println("L'employe ayant l'identifiant (id, Nom, Prenom) : " + login.getId() + " "
                    + login.getNom() + " " + login.getPrenom() + " est connecté!");
            System.out.println();
            System.out.println("*****************");
            System.out.println("** Authentification terminée avec succes ! **");
